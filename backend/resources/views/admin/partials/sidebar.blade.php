    ...
    <ul class="space-y-2">
        ...
        <li>
            ...
            <ul class="ml-6 mt-2 space-y-2 hidden">
                <li><a href="#" class="block px-2 py-1 text-sm rounded hover:bg-gray-200 dark:hover:bg-gray-700">Add Products</a></li>
                <li><a href="#" class="block px-2 py-1 text-sm rounded hover:bg-gray-200 dark:hover:bg-gray-700">View Products</a></li>
            </ul>
        </li>
        <li>
            <button class="w-full flex items-center justify-between px-4 py-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700" onclick="this.nextElementSibling.classList.toggle('hidden')">
            ...
            <ul class="ml-6 mt-2 space-y-2 hidden">
                <li><a href="#" class="block px-2 py-1 text-sm rounded hover:bg-gray-200 dark:hover:bg-gray-700">General</a></li>
